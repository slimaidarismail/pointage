...
function synchonisation(){
	...
	//echo $row['CardNo'].", ".$row['RecDate'].", ".$row['RecTime']."<br />";
		$SerialId 	= $row['SerialId'];
		$CardNo		= $row['CardNo'];
		$RecDate	= $row['RecDate'];
		$RecTime	= $row['RecTime'];
					
		$stmtMySQl = $dbh->prepare("INSERT INTO atdrecord (SerialId, CardNo, RecDate, RecTime) 
								VALUES (:SerialId, :CardNo, :RecDate, :RecTime)");
